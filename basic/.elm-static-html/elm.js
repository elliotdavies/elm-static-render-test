...
var _user$project$Main$css = A3(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('.hello { color: red; }'),
		_1: {ctor: '[]'}
	});
var _user$project$Main$view = A3(
	_elm_lang$html$Html$node,
	'html',
	{ctor: '[]'},
	{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('hello'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Heading here'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('And some copy'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		init: {
			...
			_1: _user$project$PrivateMain$htmlOut(
				A2(
					...
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'dist/index.html', _1: _user$project$Main$view},
						_1: {ctor: '[]'}
					}))
		},
		update: F2(
