...
var _user$project$Styles$testNamespace = 'test';
var _user$project$Styles$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_user$project$Styles$testNamespace);
var _user$project$Styles$class = _user$project$Styles$_p0.$class;
var _user$project$Styles$tag = function (sheet) {
...
var _user$project$Styles$Greeting = {ctor: 'Greeting'};
var _user$project$Styles$css = function (_p2) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles$testNamespace, _p2));
}(
	{
		ctor: '::',
...
var _user$project$Styles$styleTag = _user$project$Styles$tag(_user$project$Styles$css);
	...
	var greeting = A3(
		...
		_elm_lang$core$String$concat(
			A2(
				...
				', ',
				A2(_elm_lang$core$List$repeat, model.repeat, model.greeting))));
	return A3(
		_elm_lang$html$Html$node,
		'html',
		{ctor: '[]'},
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _user$project$Styles$styleTag,
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$p,
							{
								...
								_0: _user$project$Styles$class(
									{
										ctor: '::',
										_0: _user$project$Styles$Greeting,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], greeting, model.name)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {name: a, greeting: b, repeat: c};
	});
var _user$project$Main$decodeModel = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Main$Model,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'greeting', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'repeat', _elm_lang$core$Json_Decode$int));
...
var _user$project$PrivateMain$decode = function (view) {
	var _p0 = A2(
		_elm_lang$core$Json_Decode$decodeString,
		_eeue56$elm_html_in_elm$ElmHtml_InternalTypes$decodeElmHtml,
		_user$project$PrivateMain$asJsonString(view));
	if (_p0.ctor === 'Err') {
		return A2(_elm_lang$core$Basics_ops['++'], 'ERROR:', _p0._0);
	} else {
		return A2(_eeue56$elm_html_in_elm$ElmHtml_ToString$nodeToStringWithOptions, _user$project$PrivateMain$options, _p0._0);
	}
};
...
var _user$project$PrivateMain$init = function (values) {
	var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$decodeModel, values);
	if (_p1.ctor === 'Err') {
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple0'},
		...
		return {
			...
			_1: _user$project$PrivateMain$htmlOut(
				_user$project$PrivateMain$decode(
					_user$project$Main$view(_p1._0)))
		};
	}
};
var _user$project$PrivateMain$main = _elm_lang$core$Platform$programWithFlags(
	{
		init: _user$project$PrivateMain$init,
		update: F2(
			function (_p2, b) {
